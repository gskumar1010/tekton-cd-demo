...
oc adm policy add-role-to-user system:image-pusher -z pipeline
#To grant push permissions to dev namespace
oc policy add-role-to-user system:image-builder serviceaccount:pipeline -n demo-dev
